...
export var Panel = styled('div', function (props, theme) {
  return {
...
export var ActiveQueryPanel = styled('div', function (props, theme) {
  return {
    flex: '1 1 500px',
    display: 'flex',
    flexDirection: 'column',
...
export var Input = styled('input', function (props, theme) {
  return {
...
export var Select = styled('select', function (props, theme) {
  return {
    display: "inline-block",
    fontSize: ".9em",
    fontFamily: "sans-serif",
