...
(() => {
	...
	describe('Getting JSON data', () => {
		it('getIcons()', () => {
			...
			expect(
				collection.loadFromFile(__dirname + '/fixtures/test1.json')
			).to.be.equal(true);
			...
			expect(Object.keys(items.aliases)).to.be.eql([
				'arrow-circle-right',
				'arrow-down',
				'arrow-right',
			]);
			...
			expect(
				collection.loadFromFile(__dirname + '/fixtures/test1-optimized.json')
			).to.be.equal(true);
			items = collection.getIcons(['arrows', 'asterisk']);
			expect(items).to.be.eql({
				prefix: 'fa',
			...
			expect(items).to.be.eql({
				...
				icons: {
					'arrow-left': {
						body:
							'<path d="M1472 736v128q0 53-32.5 90.5T1355 992H651l293 294q38 36 38 90t-38 90l-75 76q-37 37-90 37-52 0-91-37L37 890Q0 853 0 800q0-52 37-91L688 59q38-38 91-38 52 0 90 38l75 74q38 38 38 91t-38 91L651 608h704q52 0 84.5 37.5T1472 736z" fill="currentColor"/>',
						width: 1472,
						height: 1600,
						inlineTop: -160,
					},
